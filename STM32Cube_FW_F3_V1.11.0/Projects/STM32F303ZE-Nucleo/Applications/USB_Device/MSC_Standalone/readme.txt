...
native PC Host MSC driver to which the STM32303ZE-NUCLEO board is connected.
...
@par Hardware and Software environment
  ...
  - This example has been tested with a STM32303ZE-NUCLEO board embedding
    a STM32303ZE device and can be easily tailored to any other supported device
    and development board.

  - STM32303ZE-NUCLEO Set-up
    - Insert a microSD card into the Adafruit 1.8" TFT shield uSD slot
    - Connect the STM32F303ZE-Nucleo board to the PC through 'USB Type A-Male to A-Male'
      cable to the CN13 connector.
  ...
  - Make sure the SB158 is closed and the SB165 and SB146 are opened on the Nucleo_144 board (bottom side)
