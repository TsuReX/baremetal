...
STM32F303ZE-Nucleo Rev B's LEDs can be used to monitor the application status:
  - LED3 is ON when the example runs successfully.
  - LED2 toggles in case of error in initialization or during FatFs_uSD process.
...
@par Hardware and Software environment
  ...
  - This application runs on STM32F303xE devices
    
  - This application has been tested with STM32F303ZE-Nucleo Rev B board and can be
    easily tailored to any other supported device and development board.        

  - Adafruit 1.8" TFT shield must be connected on CN8, CN9, CN10 and CN11 Arduino connectors.
