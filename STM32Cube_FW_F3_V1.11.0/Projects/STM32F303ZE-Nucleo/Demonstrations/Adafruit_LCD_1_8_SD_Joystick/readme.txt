/**
  @page Demo   Demo STM32F303ZE-Nucleo Rev B
 
  @verbatim
  ******************************************************************************
  * @file    readme.txt 
  * @author  MCD Application Team
  * @brief   Description of STM32F303ZE-Nucleo Rev B Demo
  ******************************************************************************
  * @attention
  *
...
Below you find the sequence to discover the demonstration :
 ...
 - Check the availability of adafruit 1.8" TFT shield on top of STM32 Nucleo 
   board. This is done by reading the state of IO PD.11 pin (mapped to JoyStick 
   available on adafruit 1.8" TFT shield). If the state of PD.11 is high then 
...
@par Directory contents
  ...
  - Adafruit_LCD_1_8_SD_Joystick/Inc/stm32f3xx_hal_conf.h    HAL configuration file
  - Adafruit_LCD_1_8_SD_Joystick/Inc/stm32f3xx_it.h          Interrupt handlers header file
  ...
  - Adafruit_LCD_1_8_SD_Joystick/Src/stm32f3xx_it.c          Interrupt handlers
  ...
  - Adafruit_LCD_1_8_SD_Joystick/Src/system_stm32f3xx.c      STM32F3xx system source file
