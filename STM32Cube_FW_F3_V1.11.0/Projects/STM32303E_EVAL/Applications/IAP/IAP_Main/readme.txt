/**
  @page IAP/IAP_Main AN4045 STM32F3xx In-Application Programming using the USART Readme file
...
@par Directory contents
 ...
 - "IAP/IAP_Main/Inc": contains the IAP firmware header files 
    ...
    - IAP/IAP_Main/Inc/stm32f3xx_hal_conf.h  Library Configuration file
    - IAP/IAP_Main/Inc/stm32f3xx_it.h      Header for stm32f3xx_it.c
 ...
 - "IAP/IAP_Main/Src": contains the IAP firmware source files
    ...
    - IAP/IAP_Main/Src/stm32f3xx_it.c      Interrupt handlers
    - IAP/IAP_Main/Src/stm32f3xx_hal_msp.c Microcontroller specific packages
                                                     initialization file.
    ...
    - IAP/IAP_Main/Src/system_stm32f3xx.c  STM32F3xx system source file
...
Table 1. IAP implementation on STM32303E-EVAL RevC
...
|                | (uint32_t)0x08004000(1).                              | (Page 8 - Page 255)     | 
|                | The maximum size of the image to be loaded is:        | (496 Kbytes             | 
|                | ------------------------------------------------------|-------------------------|
|                | The image is uploaded with the IAP from the STM32F3xx | 12 Kbytes               | 
 ...
 Top Flash Memory address /-------------------------------------------\  0x0807FFFF
  ...
  - STM32303E-EVAL RevC Set-up
    - Connect a null-modem female/female RS232 cable between the boards DB9 connector 
      and PC serial port.
      (make sure that jumper JP13 is set to enable RS232 communication).
