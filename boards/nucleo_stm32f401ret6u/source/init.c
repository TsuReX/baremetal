 ...
 */
#if 0
static void hse_sysclk_48mhz_init()
{
 ...
 */
#if 1
static void hsi_sysclk_48mhz_init()
{
...
{
	hsi_sysclk_48mhz_init();
//	hse_sysclk_48mhz_init();
...
//	LL_GPIO_SetPinPull(PG_VDD_PORT, PG_VDD_PIN , LL_GPIO_PULL_UP);
//
...
////	LL_GPIO_SetPinPull(PG_VCC_PORT, PG_VCC_PIN, LL_GPIO_PULL_UP);
}
