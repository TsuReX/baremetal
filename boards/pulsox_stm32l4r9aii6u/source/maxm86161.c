...
void maxm86161_i2c_write_to_register(uint8_t address, uint8_t value) {
//  HAL_StatusTypeDef status = HAL_I2C_Mem_Write(&hi2c2, MAXM86161_SLAVE_ADDRESS, address,
...
//  uint8_t bufp = 0;
//  HAL_StatusTypeDef status = HAL_I2C_Mem_Read(&hi2c2, MAXM86161_SLAVE_ADDRESS, address,
...
//  HAL_I2C_Mem_Write(&hi2c2, MAXM86161_SLAVE_ADDRESS, address,
//      I2C_MEMADD_SIZE_8BIT, values, length, 1000);
#warning Implement
}

void maxm86161_i2c_block_read(uint8_t address, uint16_t length, uint8_t* values) {
//  HAL_I2C_Mem_Read(&hi2c2, MAXM86161_SLAVE_ADDRESS, address,
//      I2C_MEMADD_SIZE_8BIT, values, length, 1000);
#warning Implement
}
 ...
 *
 * @param[in] turn_off
 * int value for turn on/off option
 *
 * @return
 *    None
 ******************************************************************************/
void maxm86161_shutdown_device(int turn_off)
{
  uint8_t value = 0;
 ...
 *    false: error
 ******************************************************************************/
int maxm86161_read_samples_in_fifo(maxm86161_ppg_sample_t *sample)
{
  uint32_t temp_data;
  uint8_t sample_cnt;
  ...
  int task_started = 0; // we only start to tream to uart incase we meet perfect sample (means PPG1, PPG2, PPG3)
