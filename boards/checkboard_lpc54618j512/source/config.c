...
void board_config(void)
{
	...
	SYSCON->PRESETCTRLSET[1] = SYSCON_PRESETCTRL_GPIO0_RST(1);
    while (0u == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO0_RST(1))) {
    }

    /* Вывести GPIO0 из состояния сброса. */
    SYSCON->PRESETCTRLCLR[1] = SYSCON_PRESETCTRL_GPIO0_RST(1);
    while (SYSCON_PRESETCTRL_GPIO0_RST(1) == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO0_RST(1))) {
    }
	...
	SYSCON->PRESETCTRLSET[1] = SYSCON_PRESETCTRL_GPIO1_RST(1);
    while (0u == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO1_RST(1))) {
    }

    /* Вывести GPIO1 из состояния сброса. */
    SYSCON->PRESETCTRLCLR[1] = SYSCON_PRESETCTRL_GPIO1_RST(1);
    while (SYSCON_PRESETCTRL_GPIO1_RST(1) == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO1_RST(1))) {
    }
	...
	SYSCON->PRESETCTRLSET[1] = SYSCON_PRESETCTRL_GPIO2_RST(1);
    while (0u == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO2_RST(1))) {
    }

    /* Вывести GPIO2 из состояния сброса. */
    SYSCON->PRESETCTRLCLR[1] = SYSCON_PRESETCTRL_GPIO2_RST(1);
    while (SYSCON_PRESETCTRL_GPIO2_RST(1) == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO2_RST(1))) {
    }
	...
	SYSCON->PRESETCTRLSET[1] = SYSCON_PRESETCTRL_GPIO3_RST(1);
    while (0u == (SYSCON->PRESETCTRL[1] & SYSCON_PRESETCTRL_GPIO3_RST(1))) {
    }
    ...
    GPIO->DIR[O_PWR_ON_BP_N_PORT] |= 0X1 << O_PWR_ON_BP_N_PORT;
    GPIO->SET[O_PWR_ON_BP_N_PORT] = 0X1 << O_PWR_ON_BP_N_PORT; /* Установить 1. */
