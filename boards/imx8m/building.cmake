...
set(BRD_PATH 			"${CMAKE_CURRENT_SOURCE_DIR}/boards/imx8m")

set(MAIN_ASM_SOURCES    "${CMAKE_CURRENT_SOURCE_DIR}/boards/imx8m/source/startup.S" )
...
set(CMAKE_C_FLAGS	"${CMAKE_C_FLAGS} -mcpu=cortex-a57 -g -ggdb")
	
set(CMAKE_ASM_FLAGS	"${CMAKE_ASM_FLAGS} -mcpu=cortex-a57 -g -ggdb")
	
set(LINKER_FLAGS		"${LINKER_FLAGS}"
						"-T ${BRD_PATH}/flash_imx8m.ld"
						"-mcpu=cortex-a57"
#						"-Wl,--gc-sections"
						"-nostdlib"
				)
