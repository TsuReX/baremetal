...
set(CURRENT_BOARD_TYPE "hostusb_stm32f103c8t6")
...
set(BOARD_SRC_PATH		"${CMAKE_CURRENT_SOURCE_DIR}/boards/hostusb_stm32f103c8t6/")

#set(MAIN_ASM_SOURCES    "${BOARD_SRC_PATH}/source/startup_stm32f103xb.s")

set(MAIN_INCLUDE		"${MAIN_INCLUDE}"
						"${CMAKE_CURRENT_SOURCE_DIR}/boards/hostusb_stm32f103c8t6/include"
						"${CMAKE_CURRENT_SOURCE_DIR}/include"
						"${BOARD_SRC_PATH}/usblib/include"
				)

set(MAIN_SOURCES		"${MAIN_SOURCES}"
						"${CMAKE_CURRENT_SOURCE_DIR}/source/stm_hostusb_main.c"
...
set(LINKER_FLAGS		"${LINKER_FLAGS}"
						"-T ${CMAKE_CURRENT_SOURCE_DIR}/boards/hostusb_stm32f103c8t6/flash_stm32f103c8t6.ld"
						"-mcpu=cortex-m3"
						"-specs=nano.specs"
						"-Wl,--gc-sections"
#						"-nostdlib"
...
add_definitions("-DPERIOD_TIMEOUT")
...
#######################################################################
#set(OOCD_CONFIG "${CMAKE_CURRENT_SOURCE_DIR}/boards/hostusb_stm32f103c8t6/oocd_stlinkv2.cfg")
set(OOCD_CONFIG "${CMAKE_CURRENT_SOURCE_DIR}/boards/hostusb_stm32f103c8t6/oocd_jlink.cfg")
# Определение дополнительной цели для выполнения операции прошивки
add_custom_target("flash" DEPENDS ${PROJ_NAME})
