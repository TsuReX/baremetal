...
void board_init(void)
{
	...
	LL_GPIO_SetPinMode(EN_CLKDIST_PORT, EN_CLKDIST_PIN, LL_GPIO_MODE_OUTPUT);
	...
	LL_GPIO_SetPinMode(EN_VDDPLL_PORT, EN_VDDPLL_PIN, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_ResetOutputPin(EN_VDDPLL_PORT, EN_VDDPLL_PIN);
	LL_GPIO_SetPinMode(PG_VLL_PORT, PG_VLL_PIN, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinPull(PG_VLL_PORT, PG_VLL_PIN, LL_GPIO_PULL_UP);
	...
	LL_GPIO_SetPinMode(JTAG_RST_PORT, JTAG_RST_PIN, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinOutputType(JTAG_RST_PORT, JTAG_RST_PIN, LL_GPIO_OUTPUT_OPENDRAIN);
	...
	LL_GPIO_SetPinMode(CORE_CLOCK_PORT, CORE_CLOCK_PIN, LL_GPIO_MODE_OUTPUT);
