...
void board_init(void)
{
	...
	/* PWRBTN_N, GPIO_EXP_BMC_IRQ_N, WDT_WDO_N, RSTBTN_N, 3v3_BMC_CPU_IRQ_N */
	GPIO_InitStruct.Pin = LL_GPIO_PIN_1|LL_GPIO_PIN_8|LL_GPIO_PIN_9|LL_GPIO_PIN_10|LL_GPIO_PIN_15;
