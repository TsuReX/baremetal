...
set(CURRENT_BOARD_TYPE "atbrk3568jsmcbmc_stm32l071kbu6")
...
set(BOARD_SRC_PATH		"${CMAKE_CURRENT_SOURCE_DIR}/boards/atbrk3568jsmcbmc_stm32l071kbu6/")
...
set(MAIN_SOURCES		"${MAIN_SOURCES}"
						...
						"${BOARD_SRC_PATH}/source/startup_stm32l071xx.c"
						"${BOARD_SRC_PATH}/source/system_stm32l0xx.c"
...
set(INCLUDE				"${INCLUDE}"
						...
						"${CMAKE_CURRENT_SOURCE_DIR}/base/device/st/stm32l0xx/include"
						
						"${CMAKE_CURRENT_SOURCE_DIR}/base/driver/st/stm32l0xx/include"
				)

set(DRV_SOURCES_PATH 	"${CMAKE_CURRENT_SOURCE_DIR}/base/driver/st/stm32l0xx/source")

set(MAIN_SOURCES		"${MAIN_SOURCES}"

						"${DRV_SOURCES_PATH}/stm32l0xx_ll_rcc.c"
						"${DRV_SOURCES_PATH}/stm32l0xx_ll_gpio.c"
#						"${DRV_SOURCES_PATH}/stm32l0xx_ll_lpuart.c"
						"${DRV_SOURCES_PATH}/stm32l0xx_ll_utils.c"
						"${DRV_SOURCES_PATH}/stm32l0xx_ll_i2c.c"
				)
