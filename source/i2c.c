...
*/
	...
	/* Уточнить, когда включать устройство относительно разрешения прерываний. */
	LL_I2C_Enable(I2C1);
}
...
int32_t i2c_receive(uint8_t chip_addr, uint8_t reg_addr, uint8_t *buffer, size_t buffer_size)
{
